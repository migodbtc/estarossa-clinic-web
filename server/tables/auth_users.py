...
@app.route('/api/auth_users', methods=['POST'])
@jwt_required()
...
@app.route('/api/auth_users', methods=['GET'])
def list_auth_users():
...
@app.route('/api/auth_users/<int:item_id>', methods=['GET'])
...
@app.route('/api/auth_users/<int:item_id>', methods=['PUT'])
@jwt_required()
...
@app.route('/api/auth_users/<int:item_id>', methods=['DELETE'])
@jwt_required()
