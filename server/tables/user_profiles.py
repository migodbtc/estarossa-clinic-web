...
@app.route('/api/user_profiles/<int:item_id>', methods=['GET'])
...
@app.route('/api/user_profiles/<int:item_id>', methods=['PUT'])
@jwt_required()
...
@app.route('/api/user_profiles/<int:item_id>', methods=['DELETE'])
@jwt_required()
